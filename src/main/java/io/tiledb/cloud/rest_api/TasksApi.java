...
public class TasksApi {
   ...
   *
   * @param namespace namespace to run task under is in (an organization name or user&#39;s
   *     username) (required)
  ...
  public okhttp3.Call runSQLCall(
      String namespace, SQLParameters sql, String acceptEncoding, final ApiCallback _callback)
      throws ApiException {
   ...
   * </table>
   */
  public List<Object> runSQL(String namespace, SQLParameters sql, String acceptEncoding)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<List<Object>> runSQLWithHttpInfo(
      String namespace, SQLParameters sql, String acceptEncoding) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call taskIdGetAsync(String id, final ApiCallback<ArrayTask> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call taskIdResultGetCall(
      String id, String acceptEncoding, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public ApiResponse<String> taskIdResultGetWithHttpInfo(String id, String acceptEncoding)
      throws ApiException {
  ...
  public okhttp3.Call taskIdResultGetAsync(
      String id, String acceptEncoding, final ApiCallback<String> _callback) throws ApiException {
   ...
   * @param type task type, \&quot;QUERY\&quot;, \&quot;SQL\&quot;, \&quot;UDF\&quot;,
   *     \&quot;GENERIC_UDF\&quot; (optional)
   * @param excludeType task_type to exclude matching array in results, more than one can be
   *     included (optional)
   * @param fileType match file_type of task array, more than one can be included (optional)
   * @param excludeFileType exclude file_type of task arrays, more than one can be included
   *     (optional)
   ...
   * </table>
   */
  public okhttp3.Call tasksGetCall(
      String namespace,
      String createdBy,
      String array,
      Integer start,
   ...
   * </table>
   */
  public ApiResponse<ArrayTaskData> tasksGetWithHttpInfo(
      String namespace,
      String createdBy,
      String array,
      Integer start,
   ...
   * </table>
   */
  public okhttp3.Call tasksGetAsync(
      String namespace,
      String createdBy,
      String array,
      Integer start,
      ...
      String search,
      String orderby,
      final ApiCallback<ArrayTaskData> _callback)
      throws ApiException {
