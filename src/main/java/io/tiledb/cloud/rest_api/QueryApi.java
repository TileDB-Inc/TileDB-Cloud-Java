...
public class QueryApi {
   ...
   * </table>
   */
  public okhttp3.Call finalizeQueryCall(
      String namespace,
      String array,
      String type,
      String contentType,
   ...
   * </table>
   */
  public ApiResponse<Query> finalizeQueryWithHttpInfo(
      String namespace,
      String array,
      String type,
      String contentType,
  ...
  /**
   * (asynchronously) send a query to run against a specified array/URI registered to a
   * group/project
   *
   * @param namespace namespace array is in (an organization name or user&#39;s username) (required)
   * @param array name/uri of array that is url-encoded (required)
   ...
   * </table>
   */
  public okhttp3.Call finalizeQueryAsync(
      String namespace,
      String array,
      String type,
      String contentType,
      ...
      String xPayer,
      Integer openAt,
      final ApiCallback<Query> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getEstResultSizesCall(
      String namespace,
      String array,
      String type,
      String contentType,
   ...
   * </table>
   */
  public Query getEstResultSizes(
      String namespace,
      String array,
      String type,
      String contentType,
   ...
   * </table>
   */
  public ApiResponse<Query> getEstResultSizesWithHttpInfo(
      String namespace,
      String array,
      String type,
      String contentType,
   ...
   * </table>
   */
  public okhttp3.Call getFileCall(
      String namespace,
      String array,
      String contentType,
      String xPayer,
  ...
  /**
   * send a query to run against a specified array/URI registered to a group/project, returns file
   * bytes
   *
   * @param namespace namespace array is in (an organization name or user&#39;s username) (required)
   * @param array name/uri of array that is url-encoded (required)
   ...
   * </table>
   */
  public File getFile(String namespace, String array, String contentType, String xPayer)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<File> getFileWithHttpInfo(
  ...
  /**
   * (asynchronously) send a query to run against a specified array/URI registered to a
   * group/project, returns file bytes
   *
   * @param namespace namespace array is in (an organization name or user&#39;s username) (required)
   * @param array name/uri of array that is url-encoded (required)
   * @param contentType Content Type of input and return mime (required)
   ...
   * </table>
   */
  public okhttp3.Call getFileAsync(
      String namespace,
      String array,
      String contentType,
      String xPayer,
   ...
   * </table>
   */
  public ApiResponse<Query> submitQueryWithHttpInfo(
      String namespace,
      String array,
      String type,
      String contentType,
   ...
   * </table>
   */
  public okhttp3.Call submitQueryAsync(
      String namespace,
      String array,
      String type,
      String contentType,
   ...
   * </table>
   */
  public okhttp3.Call submitQueryJsonCall(
      String namespace,
      String array,
      String contentType,
      QueryJson queryJson,
  ...
  /**
   * send a query to run against a specified array/URI registered to a group/project, returns JSON
   * results
   *
   * @param namespace namespace array is in (an organization name or user&#39;s username) (required)
   * @param array name/uri of array that is url-encoded (required)
   ...
   * </table>
   */
  public Object submitQueryJson(
      String namespace, String array, String contentType, QueryJson queryJson, String xPayer)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<Object> submitQueryJsonWithHttpInfo(
      String namespace, String array, String contentType, QueryJson queryJson, String xPayer)
      throws ApiException {
  ...
  /**
   * (asynchronously) send a query to run against a specified array/URI registered to a
   * group/project, returns JSON results
   *
   * @param namespace namespace array is in (an organization name or user&#39;s username) (required)
   * @param array name/uri of array that is url-encoded (required)
   * @param contentType Content Type of input and return mime (required)
   ...
   * </table>
   */
  public okhttp3.Call submitQueryJsonAsync(
      String namespace,
      String array,
      String contentType,
      QueryJson queryJson,
