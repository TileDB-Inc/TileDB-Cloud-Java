...
public class AssetsApi {
   ...
   * </table>
   */
  public okhttp3.Call changeAssetCredentialsCall(
      String namespace,
      ChangeAssetCredentialsRequest changeCredentialsRequest,
    ...
    private okhttp3.Call changeAssetCredentialsValidateBeforeCall(String namespace, ChangeAssetCredentialsRequest changeCredentialsRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = changeAssetCredentialsCall(namespace, changeCredentialsRequest, _callback);
        return localVarCall;
   ...
   * </table>
   */
  public void changeAssetCredentials(
      String namespace, ChangeAssetCredentialsRequest changeCredentialsRequest)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<Void> changeAssetCredentialsWithHttpInfo(
      String namespace, ChangeAssetCredentialsRequest changeCredentialsRequest)
      throws ApiException {
  ...
  /**
   * (asynchronously) Changes the access credentials to the given assets
   *
   * @param namespace The namespace to send the request on behalf of. (required)
   * @param changeCredentialsRequest aws access credentials to store for a namespace (required)
   ...
   * </table>
   */
  public okhttp3.Call changeAssetCredentialsAsync(
      String namespace,
      ChangeAssetCredentialsRequest changeCredentialsRequest,
   ...
   * @param orderBy order by a specific property, defaults to &#x60;created_at desc&#x60; supported
   *     values are created_at, name, asset_type can also include the order type (asc or desc)
   *     separated by space i.e. &#x60;name asc&#x60; &#x60;name desc&#x60; etc. (optional)
   ...
   * </table>
   */
  public okhttp3.Call listAssetsCall(
      String namespace,
      String assetType,
    ...
    private okhttp3.Call listAssetsValidateBeforeCall(String namespace, String assetType, String ownershipLevel, String depth, String search, Integer page, Integer perPage, String orderBy, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listAssetsCall(namespace, assetType, ownershipLevel, depth, search, page, perPage, orderBy, expand, _callback);
        return localVarCall;
  ...
  /**
   * (asynchronously) List assets in a namespace
   *
   * @param namespace namespace (required)
   * @param assetType asset_type to filter to (optional)
   * @param ownershipLevel ownership_level to filter to (owned, shared) (optional)
   ...
   * </table>
   */
  public okhttp3.Call listAssetsAsync(
      String namespace,
      String assetType,
      String ownershipLevel,
      String depth,
      ...
      String orderBy,
      String expand,
      final ApiCallback<AssetListResponse> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call listPublicAssetsCall(
      String assetType,
      String depth,
      String search,
      Integer page,
   ...
   * </table>
   */
  public AssetListResponse listPublicAssets(
      String assetType, String depth, String search, Integer page, Integer perPage, String orderBy)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<AssetListResponse> listPublicAssetsWithHttpInfo(
      String assetType, String depth, String search, Integer page, Integer perPage, String orderBy)
      throws ApiException {
  ...
  /**
   * (asynchronously) List public assets
   *
   * @param assetType asset_type to filter to (optional)
   * @param depth depth of assets to be returned (optional)
   * @param search search string (optional)
   ...
   * </table>
   */
  public okhttp3.Call listPublicAssetsAsync(
      String assetType,
      String depth,
      String search,
      Integer page,
