...
public class RegisteredTaskGraphsApi {
   ...
   * </table>
   */
  public okhttp3.Call deleteRegisteredTaskGraphCall(
   ...
   * </table>
   */
  public ApiResponse<Void> deleteRegisteredTaskGraphWithHttpInfo(String namespace, String name)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call deleteRegisteredTaskGraphAsync(
   ...
   * </table>
   */
  public okhttp3.Call getRegisteredTaskGraphCall(
      String namespace, String name, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public RegisteredTaskGraph getRegisteredTaskGraph(String namespace, String name)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<RegisteredTaskGraph> getRegisteredTaskGraphWithHttpInfo(
   ...
   * </table>
   */
  public okhttp3.Call getRegisteredTaskGraphAsync(
      String namespace, String name, final ApiCallback<RegisteredTaskGraph> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getRegisteredTaskGraphSharingPoliciesCall(
      String namespace, String name, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public List<TaskGraphSharing> getRegisteredTaskGraphSharingPolicies(String namespace, String name)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<List<TaskGraphSharing>> getRegisteredTaskGraphSharingPoliciesWithHttpInfo(
      String namespace, String name) throws ApiException {
  ...
  public okhttp3.Call getRegisteredTaskGraphSharingPoliciesAsync(
      String namespace, String name, final ApiCallback<List<TaskGraphSharing>> _callback)
      throws ApiException {
  ...
  public okhttp3.Call registerRegisteredTaskGraphCall(
      String namespace, String name, RegisteredTaskGraph graph, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public void registerRegisteredTaskGraph(String namespace, String name, RegisteredTaskGraph graph)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<Void> registerRegisteredTaskGraphWithHttpInfo(
      String namespace, String name, RegisteredTaskGraph graph) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call registerRegisteredTaskGraphAsync(
      String namespace, String name, RegisteredTaskGraph graph, final ApiCallback<Void> _callback)
      throws ApiException {
   ...
   * @param namespace The namespace that owns the registered task graph. (required)
   * @param name The name of the task graph. (required)
   * @param taskGraphSharing Namespace and list of permissions to share with. An empty list of
   ...
   *     prevent partial policies, and it&#39;s likely the UDF will not be shared with the namespace
   *     at all. (required)
   * @param _callback Callback for upload/download progress
   * @return Call to execute
   * @throws io.tiledb.cloud.rest_api.ApiException If fail to serialize the request body object
   ...
   * </table>
   */
  public okhttp3.Call shareRegisteredTaskGraphCall(
      String namespace, String name, TaskGraphSharing taskGraphSharing, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public void shareRegisteredTaskGraph(
      String namespace, String name, TaskGraphSharing taskGraphSharing) throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<Void> shareRegisteredTaskGraphWithHttpInfo(
      String namespace, String name, TaskGraphSharing taskGraphSharing) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call updateRegisteredTaskGraphCall(
      String namespace, String name, RegisteredTaskGraph graph, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
   ...
   * </table>
   */
  public void updateRegisteredTaskGraph(String namespace, String name, RegisteredTaskGraph graph)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<Void> updateRegisteredTaskGraphWithHttpInfo(
      String namespace, String name, RegisteredTaskGraph graph) throws ApiException {
