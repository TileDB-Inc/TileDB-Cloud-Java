...
public class NotebookApi {
   ...
   *
   * @param namespace namespace notebook is in (an organization name or user&#39;s username)
   *     (required)
   ...
   * </table>
   */
  public okhttp3.Call getNotebookServerStatusCall(String namespace, final ApiCallback _callback)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<NotebookStatus> getNotebookServerStatusWithHttpInfo(String namespace)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getNotebookServerStatusAsync(
      String namespace, final ApiCallback<NotebookStatus> _callback) throws ApiException {
   ...
   *     creation (optional)
   * @param endTimestamp Milliseconds since Unix epoch, copy will use open_at functionality to copy
   *     notebook created at the specific timestamp (optional)
   * @param _callback Callback for upload/download progress
   * @return Call to execute
   * @throws io.tiledb.cloud.rest_api.ApiException If fail to serialize the request body object
   * @http.response.details
   ...
   * </table>
   */
  public okhttp3.Call handleCopyNotebookCall(
      String namespace,
      String array,
   ...
   * </table>
   */
  public NotebookCopied handleCopyNotebook(
      String namespace,
      String array,
      NotebookCopy notebookCopy,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
   ...
   * </table>
   */
  public ApiResponse<NotebookCopied> handleCopyNotebookWithHttpInfo(
      String namespace,
      String array,
      NotebookCopy notebookCopy,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
   ...
   * </table>
   */
  public okhttp3.Call handleCopyNotebookAsync(
      String namespace,
      String array,
      NotebookCopy notebookCopy,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
      Integer endTimestamp,
      final ApiCallback<NotebookCopied> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call handleUploadNotebookCall(
      String namespace,
      File inputFile,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
      String outputUri,
   ...
   * </table>
   */
  public FileUploaded handleUploadNotebook(
      String namespace,
      File inputFile,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
      String outputUri,
   ...
   * </table>
   */
  public ApiResponse<FileUploaded> handleUploadNotebookWithHttpInfo(
      String namespace,
      File inputFile,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
      String outputUri,
   ...
   * </table>
   */
  public okhttp3.Call handleUploadNotebookAsync(
      String namespace,
      File inputFile,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
      String outputUri,
      String name,
      final ApiCallback<FileUploaded> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call shutdownNotebookServerCall(String namespace, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public ApiResponse<Void> shutdownNotebookServerWithHttpInfo(String namespace)
      throws ApiException {
  ...
  public okhttp3.Call shutdownNotebookServerAsync(
      String namespace, final ApiCallback<Void> _callback) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call updateNotebookNameCall(
      String namespace, String array, ArrayInfoUpdate notebookMetadata, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public void updateNotebookName(String namespace, String array, ArrayInfoUpdate notebookMetadata)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<Void> updateNotebookNameWithHttpInfo(
      String namespace, String array, ArrayInfoUpdate notebookMetadata) throws ApiException {
