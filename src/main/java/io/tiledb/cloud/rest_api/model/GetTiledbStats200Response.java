...
public class GetTiledbStats200Response {
  ...
  public GetTiledbStats200Response stats(@javax.annotation.Nullable String stats) {
    this.stats = stats;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    GetTiledbStats200Response getTiledbStats200Response = (GetTiledbStats200Response) o;
    return Objects.equals(this.stats, getTiledbStats200Response.stats);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetTiledbStats200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetTiledbStats200Response` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetTiledbStats200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetTiledbStats200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetTiledbStats200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetTiledbStats200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<GetTiledbStats200Response>() {
           @Override
