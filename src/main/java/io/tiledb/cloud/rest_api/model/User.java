...
public class User {
  ...
  public User logo(@javax.annotation.Nullable String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public User allowedActions(@javax.annotation.Nullable List<NamespaceActions> allowedActions) {
  ...
  public User defaultS3Path(@javax.annotation.Nullable String defaultS3Path) {
  ...
  public User defaultRegion(@javax.annotation.Nullable String defaultRegion) {
