...
public class NonEmptyDomain {
  ...
  public NonEmptyDomain nonEmptyDomain(@javax.annotation.Nonnull DomainArray nonEmptyDomain) {
  ...
  public void setNonEmptyDomain(@javax.annotation.Nonnull DomainArray nonEmptyDomain) {
    this.nonEmptyDomain = nonEmptyDomain;
  }


  public NonEmptyDomain isEmpty(@javax.annotation.Nonnull Boolean isEmpty) {
  ...
  public void setIsEmpty(@javax.annotation.Nonnull Boolean isEmpty) {
    this.isEmpty = isEmpty;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(nonEmptyDomain, isEmpty);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NonEmptyDomain.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NonEmptyDomain` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
