...
public class LoadArraySchemaRequest {
  ...
  public LoadArraySchemaRequest config(@javax.annotation.Nullable TileDBConfig config) {
    this.config = config;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    LoadArraySchemaRequest loadArraySchemaRequest = (LoadArraySchemaRequest) o;
    return Objects.equals(this.config, loadArraySchemaRequest.config);
  }
  ...
  public String toString() {
    ...
    sb.append("class LoadArraySchemaRequest {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!LoadArraySchemaRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `LoadArraySchemaRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LoadArraySchemaRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LoadArraySchemaRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LoadArraySchemaRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LoadArraySchemaRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<LoadArraySchemaRequest>() {
           @Override
