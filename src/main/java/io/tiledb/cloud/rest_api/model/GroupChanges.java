...
public class GroupChanges {
  ...
  public GroupChanges add(@javax.annotation.Nullable List<GroupMember> add) {
    this.add = add;
    return this;
  }
  ...
  public void setAdd(@javax.annotation.Nullable List<GroupMember> add) {
    this.add = add;
  }


  public GroupChanges remove(@javax.annotation.Nullable List<GroupMember> remove) {
    this.remove = remove;
    return this;
  }
  ...
  public void setRemove(@javax.annotation.Nullable List<GroupMember> remove) {
    this.remove = remove;
  }
