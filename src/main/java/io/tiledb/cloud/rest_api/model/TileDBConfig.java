...
import org.openapitools.client.model.TileDBConfigEntriesInner;
...
public class TileDBConfig {
  ...
  public TileDBConfig entries(@javax.annotation.Nullable List<TileDBConfigEntriesInner> entries) {
  ...
  public void setEntries(@javax.annotation.Nullable List<TileDBConfigEntriesInner> entries) {
    this.entries = entries;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!TileDBConfig.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `TileDBConfig` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if (jsonObj.get("entries") != null && !jsonObj.get("entries").isJsonNull()) {
        ...
        if (jsonArrayentries != null) {
          ...
          for (int i = 0; i < jsonArrayentries.size(); i++) {
            TileDBConfigEntriesInner.validateJsonElement(jsonArrayentries.get(i));
          };
        }
      }
  }
