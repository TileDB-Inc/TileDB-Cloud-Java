...
public class Attribute {
  ...
  public Attribute type(@javax.annotation.Nonnull Datatype type) {
    this.type = type;
    return this;
  }
  ...
  public Attribute filterPipeline(@javax.annotation.Nonnull FilterPipeline filterPipeline) {
  ...
  public void setFilterPipeline(@javax.annotation.Nonnull FilterPipeline filterPipeline) {
    this.filterPipeline = filterPipeline;
  }


  public Attribute cellValNum(@javax.annotation.Nonnull Integer cellValNum) {
  ...
  public void setCellValNum(@javax.annotation.Nonnull Integer cellValNum) {
    this.cellValNum = cellValNum;
  }


  public Attribute nullable(@javax.annotation.Nullable Boolean nullable) {
  ...
  public Attribute fillValue(@javax.annotation.Nullable List<Integer> fillValue) {
  ...
  public void setFillValue(@javax.annotation.Nullable List<Integer> fillValue) {
    this.fillValue = fillValue;
  }
