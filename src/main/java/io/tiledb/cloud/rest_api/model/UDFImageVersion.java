...
public class UDFImageVersion {
  ...
  public UDFImageVersion id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public UDFImageVersion name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UDFImageVersion udfImageUuid(@javax.annotation.Nullable String udfImageUuid) {
  ...
  public void setUdfImageUuid(@javax.annotation.Nullable String udfImageUuid) {
    this.udfImageUuid = udfImageUuid;
  }


  public UDFImageVersion dockerImage(@javax.annotation.Nullable String dockerImage) {
  ...
  public void setDockerImage(@javax.annotation.Nullable String dockerImage) {
    this.dockerImage = dockerImage;
  }


  public UDFImageVersion version(@javax.annotation.Nullable BigDecimal version) {
  ...
  public UDFImageVersion _default(@javax.annotation.Nullable Boolean _default) {
  ...
  public UDFImageVersion latest(@javax.annotation.Nullable Boolean latest) {
    this.latest = latest;
    return this;
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to UDFImageVersion
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UDFImageVersion.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UDFImageVersion.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UDFImageVersion` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
