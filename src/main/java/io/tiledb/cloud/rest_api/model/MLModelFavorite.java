...
public class MLModelFavorite {
  ...
  public MLModelFavorite mlmodelUuid(@javax.annotation.Nullable String mlmodelUuid) {
  ...
  public void setMlmodelUuid(@javax.annotation.Nullable String mlmodelUuid) {
    this.mlmodelUuid = mlmodelUuid;
  }


  public MLModelFavorite namespace(@javax.annotation.Nullable String namespace) {
  ...
  public MLModelFavorite name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MLModelFavorite.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MLModelFavorite` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
