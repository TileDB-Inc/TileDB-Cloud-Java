...
public class ArrayInfoUpdate {
  ...
  public ArrayInfoUpdate description(@javax.annotation.Nullable String description) {
  ...
  public ArrayInfoUpdate name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public ArrayInfoUpdate uri(@javax.annotation.Nullable String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public ArrayInfoUpdate fileProperties(@javax.annotation.Nullable Map<String, String> fileProperties) {
  ...
  public ArrayInfoUpdate accessCredentialsName(@javax.annotation.Nullable String accessCredentialsName) {
  ...
  public ArrayInfoUpdate logo(@javax.annotation.Nullable String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public ArrayInfoUpdate tags(@javax.annotation.Nullable List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ArrayInfoUpdate licenseId(@javax.annotation.Nullable String licenseId) {
  ...
  public ArrayInfoUpdate readOnly(@javax.annotation.Nullable Boolean readOnly) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArrayInfoUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArrayInfoUpdate` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
