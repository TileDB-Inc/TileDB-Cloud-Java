...
public class NotebookFavoritesData {
  ...
  public NotebookFavoritesData notebooks(@javax.annotation.Nullable List<ArrayInfo> notebooks) {
  ...
  public void setNotebooks(@javax.annotation.Nullable List<ArrayInfo> notebooks) {
    this.notebooks = notebooks;
  }


  public NotebookFavoritesData paginationMetadata(@javax.annotation.Nullable PaginationMetadata paginationMetadata) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!NotebookFavoritesData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `NotebookFavoritesData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
