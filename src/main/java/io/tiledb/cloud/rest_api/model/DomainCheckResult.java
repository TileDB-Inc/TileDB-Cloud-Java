...
import org.openapitools.client.model.DomainCheckStatus;
...
public class DomainCheckResult {
  ...
  public DomainCheckResult time(@javax.annotation.Nullable OffsetDateTime time) {
    this.time = time;
    return this;
  }
  ...
  public DomainCheckResult status(@javax.annotation.Nullable DomainCheckStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setStatus(@javax.annotation.Nullable DomainCheckStatus status) {
    this.status = status;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!DomainCheckResult.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `DomainCheckResult` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
