...
public class ArraySharing {
  ...
  public ArraySharing actions(@javax.annotation.Nullable List<ArrayActions> actions) {
  ...
  public void setActions(@javax.annotation.Nullable List<ArrayActions> actions) {
    this.actions = actions;
  }


  public ArraySharing namespace(@javax.annotation.Nullable String namespace) {
  ...
  public ArraySharing namespaceType(@javax.annotation.Nullable String namespaceType) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to ArraySharing
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!ArraySharing.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArraySharing.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArraySharing` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
