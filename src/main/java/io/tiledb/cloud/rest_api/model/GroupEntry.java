...
public class GroupEntry {
   ...
   * @return the GroupEntry instance itself
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.memberId, groupEntry.memberId) &&
        ...
        Objects.equals(this.additionalProperties, groupEntry.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(memberId, group, array, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<GroupEntry>() {
           ...
           public GroupEntry read(JsonReader in) throws IOException {
             ...
             GroupEntry instance = thisAdapter.fromJsonTree(jsonObj);
