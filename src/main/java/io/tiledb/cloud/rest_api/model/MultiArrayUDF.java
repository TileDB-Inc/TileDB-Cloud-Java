...
public class MultiArrayUDF {
  ...
  public MultiArrayUDF udfInfoName(@javax.annotation.Nullable String udfInfoName) {
  ...
  public void setUdfInfoName(@javax.annotation.Nullable String udfInfoName) {
    this.udfInfoName = udfInfoName;
  }


  public MultiArrayUDF language(@javax.annotation.Nullable UDFLanguage language) {
  ...
  public MultiArrayUDF version(@javax.annotation.Nullable String version) {
  ...
  public MultiArrayUDF imageName(@javax.annotation.Nullable String imageName) {
  ...
  public MultiArrayUDF accessCredentialsName(@javax.annotation.Nullable String accessCredentialsName) {
  ...
  public MultiArrayUDF resourceClass(@javax.annotation.Nullable String resourceClass) {
  ...
  public MultiArrayUDF exec(@javax.annotation.Nullable String exec) {
    this.exec = exec;
    return this;
  }
  ...
  public MultiArrayUDF execRaw(@javax.annotation.Nullable String execRaw) {
  ...
  public MultiArrayUDF resultFormat(@javax.annotation.Nullable ResultFormat resultFormat) {
  ...
  public MultiArrayUDF taskName(@javax.annotation.Nullable String taskName) {
  ...
  public MultiArrayUDF argument(@javax.annotation.Nullable String argument) {
  ...
  public void setArgument(@javax.annotation.Nullable String argument) {
    this.argument = argument;
  }


  public MultiArrayUDF argumentsJson(@javax.annotation.Nullable List<TGUDFArgument> argumentsJson) {
  ...
  public void setArgumentsJson(@javax.annotation.Nullable List<TGUDFArgument> argumentsJson) {
    this.argumentsJson = argumentsJson;
  }


  public MultiArrayUDF storedParamUuids(@javax.annotation.Nullable List<String> storedParamUuids) {
  ...
  public void setStoredParamUuids(@javax.annotation.Nullable List<String> storedParamUuids) {
    this.storedParamUuids = storedParamUuids;
  }


  public MultiArrayUDF storeResults(@javax.annotation.Nullable Boolean storeResults) {
  ...
  public MultiArrayUDF dontDownloadResults(@javax.annotation.Nullable Boolean dontDownloadResults) {
  ...
  public MultiArrayUDF ranges(@javax.annotation.Nullable QueryRanges ranges) {
    this.ranges = ranges;
    return this;
  }
  ...
  public void setRanges(@javax.annotation.Nullable QueryRanges ranges) {
    this.ranges = ranges;
  }


  public MultiArrayUDF subarray(@javax.annotation.Nullable UDFSubarray subarray) {
  ...
  public void setSubarray(@javax.annotation.Nullable UDFSubarray subarray) {
    this.subarray = subarray;
  }


  public MultiArrayUDF buffers(@javax.annotation.Nullable List<String> buffers) {
  ...
  public void setBuffers(@javax.annotation.Nullable List<String> buffers) {
    this.buffers = buffers;
  }


  public MultiArrayUDF arrays(@javax.annotation.Nullable List<UDFArrayDetails> arrays) {
    this.arrays = arrays;
    return this;
  }
  ...
  public void setArrays(@javax.annotation.Nullable List<UDFArrayDetails> arrays) {
    this.arrays = arrays;
  }


  public MultiArrayUDF timeout(@javax.annotation.Nullable Integer timeout) {
  ...
  public MultiArrayUDF taskGraphUuid(@javax.annotation.Nullable String taskGraphUuid) {
  ...
  public MultiArrayUDF clientNodeUuid(@javax.annotation.Nullable String clientNodeUuid) {
