...
public class Enumeration {
  ...
  public Enumeration name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Enumeration pathName(@javax.annotation.Nullable String pathName) {
  ...
  public Enumeration type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public Enumeration cellValNum(@javax.annotation.Nullable Integer cellValNum) {
  ...
  public void setCellValNum(@javax.annotation.Nullable Integer cellValNum) {
    this.cellValNum = cellValNum;
  }


  public Enumeration ordered(@javax.annotation.Nullable Boolean ordered) {
  ...
  public Enumeration data(@javax.annotation.Nullable List<Integer> data) {
    this.data = data;
    return this;
  }
  ...
  public Enumeration offsets(@javax.annotation.Nullable List<Integer> offsets) {
  ...
  public void setOffsets(@javax.annotation.Nullable List<Integer> offsets) {
    this.offsets = offsets;
  }
