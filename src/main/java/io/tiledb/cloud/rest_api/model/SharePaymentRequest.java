...
public class SharePaymentRequest {
  ...
  **/
   ...
   */
  public SharePaymentRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.namespaces, sharePaymentRequest.namespaces)&&
        Objects.equals(this.additionalProperties, sharePaymentRequest.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SharePaymentRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SharePaymentRequest.openapiRequiredFields.isEmpty()) {
          return;
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<SharePaymentRequest>() {
           ...
           public SharePaymentRequest read(JsonReader in) throws IOException {
             ...
             SharePaymentRequest instance = thisAdapter.fromJsonTree(jsonObj);
