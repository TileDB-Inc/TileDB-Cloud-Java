...
public class FileCreate {
  ...
  public FileCreate inputUri(@javax.annotation.Nullable String inputUri) {
  ...
  public FileCreate outputUri(@javax.annotation.Nullable String outputUri) {
  ...
  public FileCreate name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
