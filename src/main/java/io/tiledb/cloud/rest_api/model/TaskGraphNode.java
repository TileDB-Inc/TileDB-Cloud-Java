...
public class TaskGraphNode {
  ...
  public TaskGraphNode clientNodeId(@javax.annotation.Nullable String clientNodeId) {
  ...
  public void setClientNodeId(@javax.annotation.Nullable String clientNodeId) {
    this.clientNodeId = clientNodeId;
  }


  public TaskGraphNode name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public TaskGraphNode dependsOn(@javax.annotation.Nullable List<String> dependsOn) {
  ...
  public TaskGraphNode arrayNode(@javax.annotation.Nullable UDFArrayDetails arrayNode) {
  ...
  public void setArrayNode(@javax.annotation.Nullable UDFArrayDetails arrayNode) {
    this.arrayNode = arrayNode;
  }
  ...
  public TaskGraphNode sqlNode(@javax.annotation.Nullable TGSQLNodeData sqlNode) {
  ...
  public void setSqlNode(@javax.annotation.Nullable TGSQLNodeData sqlNode) {
    this.sqlNode = sqlNode;
  }


  public TaskGraphNode udfNode(@javax.annotation.Nullable TGUDFNodeData udfNode) {
  ...
  public void setUdfNode(@javax.annotation.Nullable TGUDFNodeData udfNode) {
    this.udfNode = udfNode;
  }


  public TaskGraphNode retryStrategy(@javax.annotation.Nullable RetryStrategy retryStrategy) {
  ...
  public TaskGraphNode expandNodeOutput(@javax.annotation.Nullable String expandNodeOutput) {
  ...
  public void setExpandNodeOutput(@javax.annotation.Nullable String expandNodeOutput) {
    this.expandNodeOutput = expandNodeOutput;
  }


  public TaskGraphNode deadline(@javax.annotation.Nullable Long deadline) {
