...
public class UDFSharing {
  ...
  public UDFSharing actions(@javax.annotation.Nullable List<UDFActions> actions) {
  ...
  public void setActions(@javax.annotation.Nullable List<UDFActions> actions) {
    this.actions = actions;
  }


  public UDFSharing namespace(@javax.annotation.Nullable String namespace) {
  ...
  public UDFSharing namespaceType(@javax.annotation.Nullable String namespaceType) {
