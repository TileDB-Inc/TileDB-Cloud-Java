...
import org.openapitools.client.model.AssetBackingType;
import org.openapitools.client.model.AssetOwnershipLevel;
import org.openapitools.client.model.AssetType;
import org.openapitools.client.model.MetadataStringified;
...
public class AssetInfo {
  ...
  public AssetInfo uuid(@javax.annotation.Nullable String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public AssetInfo assetType(@javax.annotation.Nullable AssetType assetType) {
  ...
  public AssetInfo assetBackingType(@javax.annotation.Nullable AssetBackingType assetBackingType) {
  ...
  public void setAssetBackingType(@javax.annotation.Nullable AssetBackingType assetBackingType) {
    this.assetBackingType = assetBackingType;
  }


  public AssetInfo assetOwnershipLevel(@javax.annotation.Nullable AssetOwnershipLevel assetOwnershipLevel) {
  ...
  public void setAssetOwnershipLevel(@javax.annotation.Nullable AssetOwnershipLevel assetOwnershipLevel) {
    this.assetOwnershipLevel = assetOwnershipLevel;
  }


  public AssetInfo namespaceName(@javax.annotation.Nullable String namespaceName) {
  ...
  public AssetInfo namespaceUuid(@javax.annotation.Nullable String namespaceUuid) {
  ...
  public void setNamespaceUuid(@javax.annotation.Nullable String namespaceUuid) {
    this.namespaceUuid = namespaceUuid;
  }


  public AssetInfo name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public AssetInfo mimeType(@javax.annotation.Nullable String mimeType) {
  ...
  public AssetInfo metadata(@javax.annotation.Nullable MetadataStringified metadata) {
  ...
  public void setMetadata(@javax.annotation.Nullable MetadataStringified metadata) {
    this.metadata = metadata;
  }
