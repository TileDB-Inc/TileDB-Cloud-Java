...
public class InvitationFailedRecipients {
  ...
  public InvitationFailedRecipients failedRecipients(@javax.annotation.Nonnull List<String> failedRecipients) {
  ...
  public void setFailedRecipients(@javax.annotation.Nonnull List<String> failedRecipients) {
    this.failedRecipients = failedRecipients;
  }
