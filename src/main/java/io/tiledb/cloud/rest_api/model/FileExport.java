 ...
 */
@ApiModel(description = "Output information required to export a file")
...
public class FileExport {
  ...
  **/
   ...
   */
  public FileExport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.outputUri, fileExport.outputUri)&&
        Objects.equals(this.additionalProperties, fileExport.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FileExport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (FileExport.openapiRequiredFields.isEmpty()) {
          return;
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<FileExport>() {
           ...
           public FileExport read(JsonReader in) throws IOException {
             ...
             FileExport instance = thisAdapter.fromJsonTree(jsonObj);
