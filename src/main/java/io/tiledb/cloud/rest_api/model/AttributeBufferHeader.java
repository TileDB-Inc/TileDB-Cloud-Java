...
public class AttributeBufferHeader {
  ...
  public AttributeBufferHeader name(@javax.annotation.Nonnull String name) {
    this.name = name;
    return this;
  }
  ...
  public AttributeBufferHeader fixedLenBufferSizeInBytes(@javax.annotation.Nonnull Integer fixedLenBufferSizeInBytes) {
  ...
  public void setFixedLenBufferSizeInBytes(@javax.annotation.Nonnull Integer fixedLenBufferSizeInBytes) {
    this.fixedLenBufferSizeInBytes = fixedLenBufferSizeInBytes;
  }


  public AttributeBufferHeader varLenBufferSizeInBytes(@javax.annotation.Nonnull Integer varLenBufferSizeInBytes) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttributeBufferHeader.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttributeBufferHeader` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
