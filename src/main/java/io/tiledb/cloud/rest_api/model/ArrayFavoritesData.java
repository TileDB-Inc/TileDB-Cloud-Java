...
public class ArrayFavoritesData {
  ...
  public ArrayFavoritesData arrays(@javax.annotation.Nullable List<ArrayInfo> arrays) {
    this.arrays = arrays;
    return this;
  }
  ...
  public void setArrays(@javax.annotation.Nullable List<ArrayInfo> arrays) {
    this.arrays = arrays;
  }


  public ArrayFavoritesData paginationMetadata(@javax.annotation.Nullable PaginationMetadata paginationMetadata) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArrayFavoritesData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArrayFavoritesData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
