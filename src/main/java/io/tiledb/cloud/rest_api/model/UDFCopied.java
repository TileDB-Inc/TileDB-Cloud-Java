...
public class UDFCopied {
  ...
  public UDFCopied outputUri(@javax.annotation.Nullable String outputUri) {
  ...
  public UDFCopied namespace(@javax.annotation.Nullable String namespace) {
  ...
  public UDFCopied name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public UDFCopied id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UDFCopied.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UDFCopied` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
