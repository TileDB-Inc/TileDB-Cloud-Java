...
public class TGUDFNodeData {
  ...
  public TGUDFNodeData registeredUdfName(@javax.annotation.Nullable String registeredUdfName) {
  ...
  public void setRegisteredUdfName(@javax.annotation.Nullable String registeredUdfName) {
    this.registeredUdfName = registeredUdfName;
  }


  public TGUDFNodeData executableCode(@javax.annotation.Nullable String executableCode) {
  ...
  public void setExecutableCode(@javax.annotation.Nullable String executableCode) {
    this.executableCode = executableCode;
  }


  public TGUDFNodeData sourceText(@javax.annotation.Nullable String sourceText) {
  ...
  public TGUDFNodeData environment(@javax.annotation.Nullable TGUDFEnvironment environment) {
  ...
  public void setEnvironment(@javax.annotation.Nullable TGUDFEnvironment environment) {
    this.environment = environment;
  }


  public TGUDFNodeData arguments(@javax.annotation.Nullable List<TGUDFArgument> arguments) {
  ...
  public void setArguments(@javax.annotation.Nullable List<TGUDFArgument> arguments) {
    this.arguments = arguments;
  }


  public TGUDFNodeData resultFormat(@javax.annotation.Nullable ResultFormat resultFormat) {
