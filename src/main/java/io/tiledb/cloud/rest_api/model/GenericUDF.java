...
public class GenericUDF {
  ...
  public GenericUDF udfInfoName(@javax.annotation.Nullable String udfInfoName) {
  ...
  public GenericUDF language(@javax.annotation.Nullable UDFLanguage language) {
  ...
  public GenericUDF version(@javax.annotation.Nullable String version) {
  ...
  public GenericUDF imageName(@javax.annotation.Nullable String imageName) {
  ...
  public GenericUDF accessCredentialsName(@javax.annotation.Nullable String accessCredentialsName) {
  ...
  public GenericUDF resourceClass(@javax.annotation.Nullable String resourceClass) {
  ...
  public GenericUDF exec(@javax.annotation.Nullable String exec) {
    this.exec = exec;
    return this;
  }
  ...
  public GenericUDF execRaw(@javax.annotation.Nullable String execRaw) {
  ...
  public GenericUDF argument(@javax.annotation.Nullable String argument) {
  ...
  public GenericUDF storedParamUuids(@javax.annotation.Nullable List<String> storedParamUuids) {
  ...
  public GenericUDF resultFormat(@javax.annotation.Nullable ResultFormat resultFormat) {
  ...
  public GenericUDF taskName(@javax.annotation.Nullable String taskName) {
  ...
  public GenericUDF storeResults(@javax.annotation.Nullable Boolean storeResults) {
  ...
  public GenericUDF timeout(@javax.annotation.Nullable Integer timeout) {
  ...
  public GenericUDF dontDownloadResults(@javax.annotation.Nullable Boolean dontDownloadResults) {
  ...
  public GenericUDF taskGraphUuid(@javax.annotation.Nullable String taskGraphUuid) {
  ...
  public GenericUDF clientNodeUuid(@javax.annotation.Nullable String clientNodeUuid) {
