...
public class ArrayTaskBrowserSidebar {
  ...
  public ArrayTaskBrowserSidebar organizations(@javax.annotation.Nullable List<String> organizations) {
  ...
  public ArrayTaskBrowserSidebar resultCountForAll(@javax.annotation.Nullable Integer resultCountForAll) {
  ...
  public ArrayTaskBrowserSidebar resultCountByNamespace(@javax.annotation.Nullable Object resultCountByNamespace) {
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!ArrayTaskBrowserSidebar.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ArrayTaskBrowserSidebar` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
