...
public class SubarrayPartitionerState {
  ...
  public SubarrayPartitionerState start(@javax.annotation.Nullable Integer start) {
    this.start = start;
    return this;
  }
  ...
  public SubarrayPartitionerState end(@javax.annotation.Nullable Integer end) {
    this.end = end;
    return this;
  }
  ...
  public SubarrayPartitionerState singleRange(@javax.annotation.Nullable List<Subarray> singleRange) {
  ...
  public void setSingleRange(@javax.annotation.Nullable List<Subarray> singleRange) {
    this.singleRange = singleRange;
  }


  public SubarrayPartitionerState multiRange(@javax.annotation.Nullable List<Subarray> multiRange) {
  ...
  public void setMultiRange(@javax.annotation.Nullable List<Subarray> multiRange) {
    this.multiRange = multiRange;
  }
