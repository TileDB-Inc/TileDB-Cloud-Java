...
public class UDFArrayDetails {
  ...
  public UDFArrayDetails parameterId(@javax.annotation.Nullable String parameterId) {
  ...
  public void setParameterId(@javax.annotation.Nullable String parameterId) {
    this.parameterId = parameterId;
  }


  public UDFArrayDetails uri(@javax.annotation.Nullable String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public UDFArrayDetails ranges(@javax.annotation.Nullable QueryRanges ranges) {
    this.ranges = ranges;
    return this;
  }
  ...
  public UDFArrayDetails buffers(@javax.annotation.Nullable List<String> buffers) {
