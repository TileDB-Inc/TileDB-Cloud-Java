...
public class GroupSharingRequest {
  ...
  public GroupSharingRequest groupActions(@javax.annotation.Nullable List<GroupActions> groupActions) {
  ...
  public GroupSharingRequest arrayActions(@javax.annotation.Nullable List<ArrayActions> arrayActions) {
  ...
  public GroupSharingRequest namespace(@javax.annotation.Nullable String namespace) {
   ...
   * @throws IOException if the JSON Element is invalid with respect to GroupSharingRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GroupSharingRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GroupSharingRequest.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GroupSharingRequest` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
