...
public class TGInputNodeData {
  ...
  public TGInputNodeData defaultValue(@javax.annotation.Nullable Object defaultValue) {
  ...
  public TGInputNodeData datatype(@javax.annotation.Nullable String datatype) {
