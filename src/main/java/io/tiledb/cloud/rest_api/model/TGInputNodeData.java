...
public class TGInputNodeData {
   ...
   * @return the TGInputNodeData instance itself
   */
  public TGInputNodeData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.defaultValue, tgInputNodeData.defaultValue) &&
        ...
        Objects.equals(this.additionalProperties, tgInputNodeData.additionalProperties);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultValue, datatype, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TGInputNodeData>() {
           ...
           public TGInputNodeData read(JsonReader in) throws IOException {
             ...
             TGInputNodeData instance = thisAdapter.fromJsonTree(jsonObj);
