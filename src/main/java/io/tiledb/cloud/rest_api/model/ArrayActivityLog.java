...
public class ArrayActivityLog {
  ...
  public ArrayActivityLog eventAt(@javax.annotation.Nullable OffsetDateTime eventAt) {
  ...
  public void setEventAt(@javax.annotation.Nullable OffsetDateTime eventAt) {
    this.eventAt = eventAt;
  }


  public ArrayActivityLog action(@javax.annotation.Nullable ActivityEventType action) {
    this.action = action;
    return this;
  }
  ...
  public void setAction(@javax.annotation.Nullable ActivityEventType action) {
    this.action = action;
  }


  public ArrayActivityLog username(@javax.annotation.Nullable String username) {
  ...
  public ArrayActivityLog bytesSent(@javax.annotation.Nullable Integer bytesSent) {
  ...
  public void setBytesSent(@javax.annotation.Nullable Integer bytesSent) {
    this.bytesSent = bytesSent;
  }


  public ArrayActivityLog bytesReceived(@javax.annotation.Nullable Integer bytesReceived) {
  ...
  public void setBytesReceived(@javax.annotation.Nullable Integer bytesReceived) {
    this.bytesReceived = bytesReceived;
  }


  public ArrayActivityLog arrayTaskId(@javax.annotation.Nullable String arrayTaskId) {
  ...
  public ArrayActivityLog id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public ArrayActivityLog queryRanges(@javax.annotation.Nullable String queryRanges) {
  ...
  public void setQueryRanges(@javax.annotation.Nullable String queryRanges) {
    this.queryRanges = queryRanges;
  }


  public ArrayActivityLog queryStats(@javax.annotation.Nullable String queryStats) {
  ...
  public void setQueryStats(@javax.annotation.Nullable String queryStats) {
    this.queryStats = queryStats;
  }
