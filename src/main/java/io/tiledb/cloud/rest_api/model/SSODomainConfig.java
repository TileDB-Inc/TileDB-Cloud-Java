...
import org.openapitools.client.model.DomainCheckResult;
import org.openapitools.client.model.DomainVerificationStatus;
import org.openapitools.client.model.SSODomainSetup;
...
public class SSODomainConfig {
  ...
  public SSODomainConfig uuid(@javax.annotation.Nullable String uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public SSODomainConfig domain(@javax.annotation.Nullable String domain) {
    this.domain = domain;
    return this;
  }
  ...
  public SSODomainConfig oidcIssuer(@javax.annotation.Nullable String oidcIssuer) {
  ...
  public void setOidcIssuer(@javax.annotation.Nullable String oidcIssuer) {
    this.oidcIssuer = oidcIssuer;
  }


  public SSODomainConfig oidcClientId(@javax.annotation.Nullable String oidcClientId) {
  ...
  public SSODomainConfig domainSetup(@javax.annotation.Nullable SSODomainSetup domainSetup) {
  ...
  public void setDomainSetup(@javax.annotation.Nullable SSODomainSetup domainSetup) {
    this.domainSetup = domainSetup;
  }


  public SSODomainConfig verificationStatus(@javax.annotation.Nullable DomainVerificationStatus verificationStatus) {
  ...
  public void setVerificationStatus(@javax.annotation.Nullable DomainVerificationStatus verificationStatus) {
    this.verificationStatus = verificationStatus;
  }


  public SSODomainConfig checkResults(@javax.annotation.Nullable List<DomainCheckResult> checkResults) {
  ...
  public void setCheckResults(@javax.annotation.Nullable List<DomainCheckResult> checkResults) {
    this.checkResults = checkResults;
  }
