...
public class InvitationArrayShareEmail {
  ...
  public InvitationArrayShareEmail actions(@javax.annotation.Nonnull List<ArrayActions> actions) {
  ...
  public void setActions(@javax.annotation.Nonnull List<ArrayActions> actions) {
    this.actions = actions;
  }


  public InvitationArrayShareEmail inviteeEmail(@javax.annotation.Nonnull List<String> inviteeEmail) {
