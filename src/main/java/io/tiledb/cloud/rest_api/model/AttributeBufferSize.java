...
public class AttributeBufferSize {
  ...
  public AttributeBufferSize attribute(@javax.annotation.Nonnull String attribute) {
  ...
  public AttributeBufferSize offsetBytes(@javax.annotation.Nonnull Integer offsetBytes) {
  ...
  public void setOffsetBytes(@javax.annotation.Nonnull Integer offsetBytes) {
    this.offsetBytes = offsetBytes;
  }


  public AttributeBufferSize dataBytes(@javax.annotation.Nonnull Integer dataBytes) {
  ...
  public void setDataBytes(@javax.annotation.Nonnull Integer dataBytes) {
    this.dataBytes = dataBytes;
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!AttributeBufferSize.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttributeBufferSize` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
