...
public class OrganizationUpdate {
  ...
  public OrganizationUpdate name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public OrganizationUpdate logo(@javax.annotation.Nullable String logo) {
    this.logo = logo;
    return this;
  }
  ...
  public OrganizationUpdate description(@javax.annotation.Nullable String description) {
  ...
  public OrganizationUpdate defaultS3Path(@javax.annotation.Nullable String defaultS3Path) {
  ...
  public OrganizationUpdate defaultS3PathCredentialsName(@javax.annotation.Nullable String defaultS3PathCredentialsName) {
