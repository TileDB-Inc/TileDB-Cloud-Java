...
public class MetadataStringifiedEntry {
  ...
  public MetadataStringifiedEntry key(@javax.annotation.Nullable String key) {
    this.key = key;
    return this;
  }
  ...
  public MetadataStringifiedEntry value(@javax.annotation.Nullable String value) {
    this.value = value;
    return this;
  }
  ...
  public MetadataStringifiedEntry type(@javax.annotation.Nullable String type) {
    this.type = type;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    MetadataStringifiedEntry metadataStringifiedEntry = (MetadataStringifiedEntry) o;
    return Objects.equals(this.key, metadataStringifiedEntry.key) &&
        Objects.equals(this.value, metadataStringifiedEntry.value) &&
        Objects.equals(this.type, metadataStringifiedEntry.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class MetadataStringifiedEntry {\n");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!MetadataStringifiedEntry.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MetadataStringifiedEntry` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MetadataStringifiedEntry.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MetadataStringifiedEntry' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MetadataStringifiedEntry> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MetadataStringifiedEntry.class));

       return (TypeAdapter<T>) new TypeAdapter<MetadataStringifiedEntry>() {
           @Override
