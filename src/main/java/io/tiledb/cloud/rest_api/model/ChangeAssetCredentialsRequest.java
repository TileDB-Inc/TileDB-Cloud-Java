...
public class ChangeAssetCredentialsRequest {
  ...
  public ChangeAssetCredentialsRequest accessCredentials(@javax.annotation.Nonnull String accessCredentials) {
  ...
  public void setAccessCredentials(@javax.annotation.Nonnull String accessCredentials) {
    this.accessCredentials = accessCredentials;
  }


  public ChangeAssetCredentialsRequest assetUuids(@javax.annotation.Nonnull List<String> assetUuids) {
  ...
  public void setAssetUuids(@javax.annotation.Nonnull List<String> assetUuids) {
    this.assetUuids = assetUuids;
  }
