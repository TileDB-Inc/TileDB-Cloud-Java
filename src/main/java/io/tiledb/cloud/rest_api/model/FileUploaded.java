...
public class FileUploaded {
  ...
  public FileUploaded outputUri(@javax.annotation.Nullable String outputUri) {
  ...
  public FileUploaded fileName(@javax.annotation.Nullable String fileName) {
  ...
  public FileUploaded id(@javax.annotation.Nonnull String id) {
    this.id = id;
    return this;
  }
