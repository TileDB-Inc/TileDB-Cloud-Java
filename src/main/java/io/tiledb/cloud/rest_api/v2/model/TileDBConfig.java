 ...
 */
@ApiModel(description = "TileDB config used for interaction with the embedded library")
...
public class TileDBConfig {
  ...
  private List<TileDBConfigEntriesInner> entries = null;
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (jsonArrayentries != null) {
        ...
        for (int i = 0; i < jsonArrayentries.size(); i++) {
          TileDBConfigEntriesInner.validateJsonObject(jsonArrayentries.get(i).getAsJsonObject());
        };
      }
  }
