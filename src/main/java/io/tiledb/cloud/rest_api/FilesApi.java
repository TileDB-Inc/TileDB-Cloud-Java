...
public class FilesApi {
   ...
   * </table>
   */
  public okhttp3.Call handleCreateFileCall(
      String namespace,
   ...
   * </table>
   */
  public FileCreated handleCreateFile(
      String namespace, FileCreate fileCreate, String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<FileCreated> handleCreateFileWithHttpInfo(
      String namespace, FileCreate fileCreate, String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call handleCreateFileAsync(
      String namespace,
      FileCreate fileCreate,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
      final ApiCallback<FileCreated> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call handleExportFileCall(
      String namespace, String _file, FileExport fileExport, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public FileExported handleExportFile(String namespace, String _file, FileExport fileExport)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<FileExported> handleExportFileWithHttpInfo(
      String namespace, String _file, FileExport fileExport) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call handleExportFileAsync(
      String namespace,
      String _file,
      FileExport fileExport,
      final ApiCallback<FileExported> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public FileUploaded handleUploadFile(
      String namespace,
      File inputFile,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
      String outputUri,
   ...
   * </table>
   */
  public ApiResponse<FileUploaded> handleUploadFileWithHttpInfo(
      String namespace,
      File inputFile,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
      String outputUri,
   ...
   * </table>
   */
  public okhttp3.Call handleUploadFileAsync(
      String namespace,
      File inputFile,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
      String outputUri,
