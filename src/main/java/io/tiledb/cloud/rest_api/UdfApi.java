...
public class UdfApi {
   ...
   * </table>
   */
  public okhttp3.Call deleteUDFInfoCall(String namespace, String name, final ApiCallback _callback)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<Void> deleteUDFInfoWithHttpInfo(String namespace, String name)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call deleteUDFInfoAsync(
   ...
   * </table>
   */
  public okhttp3.Call getUDFInfoCall(String namespace, String name, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public ApiResponse<UDFInfo> getUDFInfoWithHttpInfo(String namespace, String name)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getUDFInfoAsync(
      String namespace, String name, final ApiCallback<UDFInfo> _callback) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call getUDFInfoSharingPoliciesCall(
   ...
   * </table>
   */
  public List<UDFSharing> getUDFInfoSharingPolicies(String namespace, String name)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<List<UDFSharing>> getUDFInfoSharingPoliciesWithHttpInfo(
  ...
  public okhttp3.Call getUDFInfoSharingPoliciesAsync(
      String namespace, String name, final ApiCallback<List<UDFSharing>> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call handleCopyUDFCall(
      String namespace,
      String name,
      UDFCopy udFCopy,
   ...
   * </table>
   */
  public UDFCopied handleCopyUDF(
      String namespace,
      String name,
      UDFCopy udFCopy,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
   ...
   * </table>
   */
  public ApiResponse<UDFCopied> handleCopyUDFWithHttpInfo(
      String namespace,
      String name,
      UDFCopy udFCopy,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
   ...
   * </table>
   */
  public okhttp3.Call handleCopyUDFAsync(
      String namespace,
      String name,
      UDFCopy udFCopy,
      String X_TILEDB_CLOUD_ACCESS_CREDENTIALS_NAME,
      Integer endTimestamp,
      final ApiCallback<UDFCopied> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call registerUDFInfoCall(
      String namespace, String name, UDFInfoUpdate udf, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public void registerUDFInfo(String namespace, String name, UDFInfoUpdate udf)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<Void> registerUDFInfoWithHttpInfo(
      String namespace, String name, UDFInfoUpdate udf) throws ApiException {
  ...
  public okhttp3.Call registerUDFInfoAsync(
      String namespace, String name, UDFInfoUpdate udf, final ApiCallback<Void> _callback)
      throws ApiException {
   ...
   * @param namespace namespace array is in (an organization name or user&#39;s username) (required)
   * @param name name of UDFInfo (required)
   * @param udfSharing Namespace and list of permissions to share with. An empty list of permissions
   *     will remove the namespace; if permissions already exist they will be deleted then new ones
   *     added. In the event of a failure, the new policies will be rolled back to prevent partial
   *     policies, and it&#39;s likely the UDF will not be shared with the namespace at all.
   *     (required)
   * @param _callback Callback for upload/download progress
   * @return Call to execute
   * @throws io.tiledb.cloud.rest_api.ApiException If fail to serialize the request body object
   ...
   * </table>
   */
  public okhttp3.Call shareUDFInfoCall(
      String namespace, String name, UDFSharing udfSharing, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public void shareUDFInfo(String namespace, String name, UDFSharing udfSharing)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<Void> shareUDFInfoWithHttpInfo(
      String namespace, String name, UDFSharing udfSharing) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call shareUDFInfoAsync(
      String namespace, String name, UDFSharing udfSharing, final ApiCallback<Void> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call submitGenericUDFCall(
      String namespace, GenericUDF udf, String acceptEncoding, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public File submitGenericUDF(String namespace, GenericUDF udf, String acceptEncoding)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<File> submitGenericUDFWithHttpInfo(
      String namespace, GenericUDF udf, String acceptEncoding) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call submitGenericUDFAsync(
      String namespace, GenericUDF udf, String acceptEncoding, final ApiCallback<File> _callback)
      throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call submitMultiArrayUDFCall(
      String namespace, MultiArrayUDF udf, String acceptEncoding, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
   ...
   * </table>
   */
  public File submitMultiArrayUDF(String namespace, MultiArrayUDF udf, String acceptEncoding)
      throws ApiException {
   ...
   * </table>
   */
  public ApiResponse<File> submitMultiArrayUDFWithHttpInfo(
      String namespace, MultiArrayUDF udf, String acceptEncoding) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call submitMultiArrayUDFAsync(
      String namespace, MultiArrayUDF udf, String acceptEncoding, final ApiCallback<File> _callback)
      throws ApiException {
   ...
   * @param acceptEncoding Encoding to use (optional)
   * @param v2 flag to indicate if v2 array UDFs should be used, currently in beta testing. Setting
   *     any value will enable v2 array UDFs. (optional)
   * @param _callback Callback for upload/download progress
   * @return Call to execute
   * @throws io.tiledb.cloud.rest_api.ApiException If fail to serialize the request body object
   * @http.response.details
   ...
   * </table>
   */
  public okhttp3.Call submitUDFCall(
      String namespace,
      String array,
      MultiArrayUDF udf,
      String xPayer,
   ...
   * </table>
   */
  public ApiResponse<File> submitUDFWithHttpInfo(
      String namespace,
      String array,
      MultiArrayUDF udf,
      String xPayer,
   ...
   * </table>
   */
  public okhttp3.Call submitUDFAsync(
      String namespace,
      String array,
      MultiArrayUDF udf,
      String xPayer,
   ...
   * </table>
   */
  public okhttp3.Call udfNamespaceArrayEndTimestampsGetCall(
   ...
   * </table>
   */
  public ArrayEndTimestampData udfNamespaceArrayEndTimestampsGet(
   ...
   * </table>
   */
  public ApiResponse<ArrayEndTimestampData> udfNamespaceArrayEndTimestampsGetWithHttpInfo(
      String namespace, String array, Integer page, Integer perPage) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call udfNamespaceArrayEndTimestampsGetAsync(
      String namespace,
      String array,
      Integer page,
      Integer perPage,
   ...
   * </table>
   */
  public okhttp3.Call updateUDFInfoCall(
      String namespace, String name, UDFInfoUpdate udf, final ApiCallback _callback)
      throws ApiException {
        String basePath = null;
        // Operation Servers
   ...
   * </table>
   */
  public ApiResponse<Void> updateUDFInfoWithHttpInfo(
      String namespace, String name, UDFInfoUpdate udf) throws ApiException {
   ...
   * </table>
   */
  public okhttp3.Call updateUDFInfoAsync(
      String namespace, String name, UDFInfoUpdate udf, final ApiCallback<Void> _callback)
      throws ApiException {
