...
import io.tiledb.cloud.v4.auth.Authentication;
import io.tiledb.cloud.v4.auth.HttpBasicAuth;
import io.tiledb.cloud.v4.auth.HttpBearerAuth;
import io.tiledb.cloud.v4.auth.ApiKeyAuth;
import io.tiledb.cloud.v4.auth.OAuth;
import io.tiledb.cloud.v4.auth.RetryingOAuth;
import io.tiledb.cloud.v4.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://api.tiledb.com/v4";
     ...
     * @return a {@link io.tiledb.cloud.v4.ApiClient} object
     */
    ...
    */
     ...
     * @throws io.tiledb.cloud.v4.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws io.tiledb.cloud.v4.ApiException If fail to serialize the given object
     */
     ...
     * @throws io.tiledb.cloud.v4.ApiException If fail to read file content from response and write to disk
     ...
     * @throws io.tiledb.cloud.v4.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws io.tiledb.cloud.v4.ApiException If the response has an unsuccessful status code or
     ...
     * @throws io.tiledb.cloud.v4.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws io.tiledb.cloud.v4.ApiException If fails to update the parameters
     */
     ...
     * @throws io.tiledb.cloud.v4.ApiException If fail to serialize the request body object into a string
     */
